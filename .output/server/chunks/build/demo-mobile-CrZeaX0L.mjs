...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/MobileDeviceFrame.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_0 = Object.assign(_sfc_main$1, { __name: "MobileDeviceFrame" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "demo-mobile",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_MobileDeviceFrame = __nuxt_component_0;
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gradient-to-br from-white via-slate-50 to-blue-50" }, _attrs))}><section class="container mx-auto px-4 py-10 flex items-center justify-center">`);
      _push(ssrRenderComponent(_component_MobileDeviceFrame, {
        src: "/images/manometro.png",
        alt: "Exemplo de imagem dentro da moldura de dispositivo móvel"
      }, null, _parent));
      _push(`</section></main>`);
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/demo-mobile.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=demo-mobile-CrZeaX0L.mjs.map
