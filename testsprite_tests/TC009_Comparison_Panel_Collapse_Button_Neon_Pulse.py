...
async def run_test():
    ...
    try:
        ...
        # -> Login with valid credentials to access products page.
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Comparison Panel Neon Pulse Active').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: The collapse button for the comparison panel did not pulse with neon green effect when collapsed as required by the test plan.")
