<template>
  <!-- Moldura de dispositivo móvel responsiva com suporte a tema claro/escuro -->
  <div class="w-full max-w-[433px] mx-auto">
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      :width="!responsive && width ? width : undefined"
      :height="!responsive && height ? height : undefined"
      viewBox="0 0 433 882"
      class="w-full h-auto"
      role="img"
      aria-label="Moldura de dispositivo móvel"
    >
