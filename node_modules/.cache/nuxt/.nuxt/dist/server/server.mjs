import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, ref, Suspense, Fragment, computed, createVNode, resolveDynamicComponent, mergeProps, withCtx, unref, createBlock, renderSlot, openBlock, useSSRContext, watch, toDisplayString, createTextVNode, createCommentVNode, renderList, resolveDirective, withModifiers, useAttrs, withKeys, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/Users/Vendas2/Desktop/template-nuxt-supabase-tailwind-master/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/Vendas2/Desktop/template-nuxt-supabase-tailwind-master/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/Vendas2/Desktop/template-nuxt-supabase-tailwind-master/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, setCookie, getHeader } from "C:/Users/Vendas2/Desktop/template-nuxt-supabase-tailwind-master/node_modules/h3/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "C:/Users/Vendas2/Desktop/template-nuxt-supabase-tailwind-master/node_modules/radix3/dist/index.mjs";
import { defu } from "C:/Users/Vendas2/Desktop/template-nuxt-supabase-tailwind-master/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "C:/Users/Vendas2/Desktop/template-nuxt-supabase-tailwind-master/node_modules/ufo/dist/index.mjs";
import { createServerClient, parseCookieHeader } from "@supabase/ssr";
import "C:/Users/Vendas2/Desktop/template-nuxt-supabase-tailwind-master/node_modules/klona/dist/index.mjs";
import { ssrRenderVNode, ssrRenderSlot, ssrRenderAttrs, ssrRenderComponent, ssrRenderTeleport, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderList, ssrGetDirectiveProps, ssrGetDynamicModelProps, ssrRenderStyle, ssrRenderSuspense } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BuX8JVkf.js")
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-CDQC_uyV.js")
  },
  {
    name: "comparar",
    path: "/comparar",
    component: () => import("./_nuxt/comparar-CjW9pDWw.js")
  },
  {
    name: "produtos",
    path: "/produtos",
    component: () => import("./_nuxt/produtos-DqVQwF-e.js")
  },
  {
    name: "demo-mobile",
    path: "/demo-mobile",
    component: () => import("./_nuxt/demo-mobile-CrZeaX0L.js")
  },
  {
    name: "teste-filtros",
    path: "/teste-filtros",
    component: () => import("./_nuxt/teste-filtros-C3XAXZOE.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-sjjKH8D2.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DtWDDJ8U.js"));
...
export {
  FavoriteIconButton as F,
  ProductDetailsModal as P,
  RainbowButton as R,
  UiModal as U,
  _export_sfc as _,
  useNuxtApp as a,
